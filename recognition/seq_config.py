...
dataset.multidata.dataset_path = ['../datasets/faces_emore','../datasets/glint_asia']
dataset.multidata.num_classes = [85742,93979]
dataset.multidata.image_shape = (112,112,3)
dataset.multidata.val_targets = ['lfw', 'cfp_fp', 'agedb_30']
...
auxloss.center.center_alpha = 0.95
...
def generate_config(_network, _dataset, _loss, _auxloss):
