...
def parse_args():
  ...
  # general
  parser.add_argument('--data', default='/gpu/data2/jiaguo/iqiyi/trainval', help='')
  parser.add_argument('--prefix', default='./model/iqiyia', help='directory to save model.')
  ...
  parser.add_argument('--per-batch-size', type=int, default=4096, help='batch size in each context')
