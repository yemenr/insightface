...
parser.add_argument('--model', default='../iqiyi-competition/models2/model-r100-gg/model,0', help='path to load model.') #0.875
...
parser.add_argument('--input', default='./det1', help='')
